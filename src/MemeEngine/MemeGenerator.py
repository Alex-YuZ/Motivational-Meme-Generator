...
class MemeEngine():
    ...
    def make_meme(self, img_path, text, author, width=500) -> str:
        ...
        font = ImageFont.truetype('./MemeEngine/LilitaOne-Regular.ttf', size=20)
        draw.text((random_width, random_height), msg, font=font, fill='yellow')

        # string for the file name (directory) of the generated meme
        file_path = "{}/{}.png".format(self.output_dir, random.randint(0, 1000))
